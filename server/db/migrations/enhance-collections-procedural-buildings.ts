...
const THEMES: Record<string, WorldTheme> = {
  ...
  'historical-french-colonial': {
    categories: {
      commercial_food: cat([[0.9, 0.85, 0.7], [0.85, 0.75, 0.55], [0.92, 0.88, 0.75]], [0.25, 0.2, 0.15], [0.75, 0.8, 0.85], [0.3, 0.45, 0.35], 'stucco', 'creole', { roofStyle: 'hip', hasBalcony: true, hasIronworkBalcony: true, hasPorch: true, hasShutters: true, porchDepth: 4, porchSteps: 3, shutterColor: { r: 0.2, g: 0.35, b: 0.28 }, wallTexture: 'plaster_02', roofTexture: 'clay_roof_tiles_02' }),
      commercial_retail: cat([[0.75, 0.82, 0.78], [0.7, 0.78, 0.85], [0.82, 0.7, 0.72]], [0.25, 0.2, 0.15], [0.75, 0.8, 0.85], [0.3, 0.45, 0.35], 'stucco', 'creole', { roofStyle: 'hip', hasBalcony: true, hasIronworkBalcony: true, hasPorch: true, hasShutters: true, porchDepth: 4, porchSteps: 3, shutterColor: { r: 0.2, g: 0.35, b: 0.28 }, wallTexture: 'plaster_02', roofTexture: 'clay_roof_tiles_02' }),
      commercial_service: cat([[0.9, 0.85, 0.7], [0.88, 0.78, 0.68]], [0.25, 0.2, 0.15], [0.75, 0.8, 0.85], [0.3, 0.45, 0.35], 'stucco', 'creole', { roofStyle: 'hip', hasBalcony: true, hasIronworkBalcony: true, hasPorch: true, hasShutters: true, porchDepth: 4, porchSteps: 3, shutterColor: { r: 0.2, g: 0.35, b: 0.28 } }),
      civic: cat([[0.92, 0.9, 0.85], [0.85, 0.82, 0.75]], [0.25, 0.2, 0.15], [0.75, 0.8, 0.85], [0.35, 0.25, 0.18], 'brick', 'creole', { roofStyle: 'hipped_dormers', hasBalcony: true, hasIronworkBalcony: true, hasShutters: true, shutterColor: { r: 0.2, g: 0.35, b: 0.28 }, wallTexture: 'brick_wall_001' }),
      industrial: cat([[0.7, 0.62, 0.5], [0.65, 0.58, 0.48]], [0.3, 0.28, 0.22], [0.65, 0.68, 0.7], [0.4, 0.3, 0.2], 'brick', 'creole', { roofStyle: 'gable', hasShutters: true, shutterColor: { r: 0.2, g: 0.35, b: 0.28 }, wallTexture: 'brown_brick_02' }),
      maritime: cat([[0.8, 0.85, 0.88], [0.7, 0.78, 0.85]], [0.25, 0.2, 0.15], [0.75, 0.8, 0.85], [0.3, 0.45, 0.35], 'wood', 'creole', { roofStyle: 'hip', hasPorch: true, hasShutters: true, porchDepth: 3, porchSteps: 2, shutterColor: { r: 0.2, g: 0.35, b: 0.28 } }),
      residential: cat([[0.9, 0.85, 0.7], [0.85, 0.75, 0.55], [0.75, 0.82, 0.78], [0.88, 0.78, 0.68], [0.7, 0.78, 0.85], [0.82, 0.7, 0.72], [0.92, 0.88, 0.75]], [0.25, 0.2, 0.15], [0.75, 0.8, 0.85], [0.3, 0.45, 0.35], 'wood', 'creole', { roofStyle: 'hip', hasBalcony: true, hasIronworkBalcony: true, hasPorch: true, hasShutters: true, porchDepth: 4, porchSteps: 3, shutterColor: { r: 0.2, g: 0.35, b: 0.28 }, wallTexture: 'plaster_02', roofTexture: 'clay_roof_tiles_02' }),
    },
    ground: { texture: 'forest_floor', color: { r: 0.35, g: 0.5, b: 0.3 } },

...
const VALID_EVENT_TYPES: Array[String] = [
	...
	EVENT_ASSESSMENT_PHASE_COMPLETED, EVENT_ASSESSMENT_COMPLETED,
	EVENT_ONBOARDING_STEP_STARTED, EVENT_ONBOARDING_STEP_COMPLETED,
...
##   assessment_started:  {type, session_id, assessment_type, player_id}
##   assessment_phase_started: {type, session_id, phase_id, phase_index}
##   assessment_phase_completed: {type, session_id, phase_id, score, max_score}
##   assessment_completed: {type, session_id, total_score, total_max_score, cefr_level}

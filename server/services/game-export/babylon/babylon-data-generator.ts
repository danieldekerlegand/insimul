...
export function generateDataFiles(ir: WorldIR): GeneratedFile[] {
  ...
  files.push({
    path: 'src/data/world_ir.json',
    content: JSON.stringify(ir, null, 2),
  });

  // Characters
  files.push({
    path: 'src/data/characters.json',

...
import type { LanguageProgress, GrammarPattern, VocabularyEntry } from '../../shared/language/progress.js';
import type { QuestTemplate } from '../../shared/language/quest-templates.js';

/**
 * Assessment Quest Bridge
 *
 * Wraps the Departure assessment (shared/assessment/departure-encounter.ts)
 * into the quest tracking system so it appears in the quest log with 4 phase-
 * based objectives. On completion, compares arrival vs departure scores to
 * generate a Language Learning Report Card showing improvement deltas.
 */

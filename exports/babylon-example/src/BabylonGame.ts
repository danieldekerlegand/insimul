...
import { Action, ActionContext, ActionResult } from "./types/actions.ts";
import { ActionManager } from "./actions/ActionManager.ts";
import { TextureManager } from "./TextureManager.ts";
import { AudioManager } from "./AudioManager.ts";
import { CameraManager, CameraMode } from "./CameraManager.ts";
import { BabylonGUIManager } from "./BabylonGUIManager.ts";
import { BabylonChatPanel } from "./BabylonChatPanel.ts";
import { BabylonQuestTracker } from "./BabylonQuestTracker.ts";
import { BabylonRadialMenu } from "./BabylonRadialMenu.ts";
import { QuestObjectManager } from "./QuestObjectManager.ts";
import { QuestIndicatorManager } from "./QuestIndicatorManager.ts";
import { QuestWorldObjectLinker } from "./QuestWorldObjectLinker.ts";
import { ListeningComprehensionManager } from "./ListeningComprehensionManager.ts";
import { ProceduralBuildingGenerator, BuildingStyle } from "./ProceduralBuildingGenerator.ts";
import { computeFoundationData } from "./TerrainFoundationRenderer.ts";
import { ProceduralNatureGenerator, BiomeStyle } from "./ProceduralNatureGenerator.ts";
import { AnimalNPCSystem } from "./AnimalNPCSystem.ts";
import { RoadGenerator } from "./RoadGenerator.ts";
import { RiverGenerator } from "./RiverGenerator.ts";
import { WaterRenderer } from "./WaterRenderer.ts";
import { buildStreetNetwork } from "./StreetNetworkLayout.ts";
import { NPCScheduleSystem } from "./NPCScheduleSystem.ts";
import { NPCLocationCycler } from "./NPCLocationCycler.ts";
import { VolitionSystem, type NPCState as VolitionNPCState, type VolitionGoal, TERMINAL_ACTIONS } from "./VolitionSystem.ts";
import { WorldScaleManager, ScaledSettlement } from "./WorldScaleManager.ts";
import { BuildingInfoDisplay } from "./BuildingInfoDisplay.ts";
import { ChunkManager } from "./ChunkManager.ts";
import { FullscreenMap } from "./FullscreenMap.ts";
import { BabylonMinimap } from "./BabylonMinimap.ts";
import { renderWorldCanvas } from "./MinimapTerrainRenderer.ts";
import { BabylonInventory, InventoryItem } from "./BabylonInventory.ts";
import { TerrainRenderer } from "./TerrainRenderer.ts";
import { BabylonShopPanel, ShopTransaction } from "./BabylonShopPanel.ts";
import { BabylonContainerPanel, ContainerTransaction } from "./BabylonContainerPanel.ts";
import { BabylonRulesPanel, Rule } from "./BabylonRulesPanel.ts";
import { RuleEnforcer, RuleViolation } from "./RuleEnforcer.ts";
import { CombatSystem, CombatStyle, DamageResult } from "./CombatSystem.ts";
import { EquipmentManager } from "./EquipmentManager.ts";
import { RangedCombatSystem } from "./RangedCombatSystem.ts";
import { FightingCombatSystem } from "./FightingCombatSystem.ts";
import { TurnBasedCombatSystem } from "./TurnBasedCombatSystem.ts";
import { GenreUIManager, GenreUIConfig } from "./GenreUIManager.ts";
import { ResourceSystem } from "./ResourceSystem.ts";
import { CraftingSystem } from "./CraftingSystem.ts";
import { BuildingPlacementSystem } from "./BuildingPlacementSystem.ts";
import { SurvivalNeedsSystem } from "./SurvivalNeedsSystem.ts";
import { RunManager } from "./RunManager.ts";
import { ProceduralDungeonGenerator } from "./ProceduralDungeonGenerator.ts";
import { getGenreConfig } from "@shared/game-genres/index";
import { HealthBar } from "./HealthBar.ts";
import { CombatUI } from "./CombatUI.ts";
import { VRManager } from "./VRManager.ts";
import { VRUIPanel, VRHandMenu } from "./VRUIPanel.ts";
import { VRInteractionManager } from "./VRInteractionManager.ts";
import { resolveNPCModelFromCharacter } from "./NPCModelManifest.ts";
import { VRHUDManager } from "./VRHUDManager.ts";
import { VRCombatAdapter } from "./VRCombatAdapter.ts";
import { BabylonVocabularyPanel } from "./BabylonVocabularyPanel.ts";
import { BuildingSignManager, BuildingSignData } from "./BuildingSignManager.ts";
import { getResidenceSign, getBusinessSign } from "@shared/language/world-sign-provider";
import { LanguageGamificationTracker } from "./LanguageGamificationTracker.ts";
import { QuestCompletionManager } from "./QuestCompletionManager.ts";
import { QuestAutoCompletionDetector } from "./QuestAutoCompletionDetector.ts";
import { BabylonConversationHistoryPanel } from "./BabylonConversationHistoryPanel.ts";
import { BabylonSkillTreePanel } from "./BabylonSkillTreePanel.ts";
import { EnvironmentalAudioManager } from "./EnvironmentalAudioManager.ts";
import { CulturalEventManager } from "./CulturalEventManager.ts";
import { BabylonNoticeBoardPanel, type NoticeArticle } from "./BabylonNoticeBoardPanel.ts";
import { SettlementNoticeBoard } from "./SettlementNoticeBoard.ts";
import { generateSettlementNotices, type NPCAuthorInfo } from "./NoticeGenerator.ts";
import { ContentGatingManager } from "./ContentGatingManager.ts";
import { generateQuestSuggestions, selectQuestForNPC } from "./DynamicQuestBoard.ts";
import { VRChatPanel } from "./VRChatPanel.ts";
import { VRVocabularyLabels } from "./VRVocabularyLabels.ts";
import { VRHandTrackingManager } from "./VRHandTrackingManager.ts";
import {
  createDebugLabel,
  ...
  clearDebugHighlight,
  buildDebugLabel,
} from "./DebugLabelUtils.ts";
import { VRAccessibilityManager } from "./VRAccessibilityManager.ts";
import { NPCTalkingIndicator } from "./NPCTalkingIndicator.ts";
import { NPCAmbientConversationManager } from "./NPCAmbientConversationManager.ts";
import { VehicleSystem } from "./VehicleSystem.ts";
import { AmbientLifeBehaviorSystem, type NearbyBuildingInfo, type NearbyNPCInfo } from "./AmbientLifeBehaviorSystem.ts";
import { NPCInitiatedConversationController } from "./NPCInitiatedConversationController.ts";
import { NPCSocializationController } from "./NPCSocializationController.ts";
import type { SocializableNPC, ConversationResult } from "./NPCSocializationController.ts";
import { BuildingInteriorGenerator, InteriorLayout } from "./BuildingInteriorGenerator.ts";
import { InteriorSceneManager, getInteriorModelPath } from "./InteriorSceneManager.ts";
import { OutdoorFurnitureGenerator, getFurnitureSet, FURNITURE_ROLE_MAP, FURNITURE_SIZE_MAP, type OutdoorFurnitureType } from "./OutdoorFurnitureGenerator.ts";
import { FurnitureModelLoader } from "./FurnitureModelLoader.ts";
import { InteriorItemManager } from "./InteriorItemManager.ts";
import { ExteriorItemManager } from "./ExteriorItemManager.ts";
import { GameMenuSystem, GameMenuCallbacks, SaveSlotInfo, type MenuJournalData } from "./GameMenuSystem.ts";
import { MainMenuScreen, type PlaythroughInfo } from "./MainMenuScreen.ts";
import { WorldStateManager, type GameStateSource, type GameStateTarget } from "./WorldStateManager.ts";
import { SaveIndicator } from "./SaveIndicator.ts";
import { DataSource, createDataSource } from "./DataSource.ts";
import { PlaythroughQuestOverlay } from "./PlaythroughQuestOverlay.ts";
import { RelationshipManager } from "./RelationshipManager.ts";
import { SettlementSceneManager, SettlementZone } from "./SettlementSceneManager.ts";
import { GamePrologEngine } from "./GamePrologEngine.ts";
import { GameEventBus } from "./GameEventBus.ts";
import { GameTimeManager } from "./GameTimeManager.ts";
import { WeatherSystem } from "./WeatherSystem.ts";
import { DayNightCycle } from "./DayNightCycle.ts";
import { BuildingCollisionSystem } from "./BuildingCollisionSystem.ts";
import { BuildingEntrySystem } from "./BuildingEntrySystem.ts";
import { InteriorNPCManager } from "./InteriorNPCManager.ts";
import { NPCBusinessInteractionSystem, type BusinessInteraction, type ServiceResult } from "./NPCBusinessInteractionSystem.ts";
import { BusinessBehaviorSystem } from "./BusinessBehaviorSystem.ts";
import { BusinessPopulationManager } from "./BusinessPopulationManager.ts";
import { NPCSimulationLOD } from "./NPCSimulationLOD.ts";
import { generateNPCAppearance, generateBillboardColor, blendWithRoleTint, getClothingColorForMesh, type NPCAppearance } from "./NPCAppearanceGenerator.ts";
import { NPCAccessorySystem } from "./NPCAccessorySystem.ts";
import { NPCInteractionPrompt } from "./NPCInteractionPrompt.ts";
import { WorldObjectActionManager } from "./WorldObjectActionManager.ts";
import { NPCModelInstancer } from "./NPCModelInstancer.ts";
import { NPCModularAssembler, deriveBodyType as deriveModularBodyType } from "./NPCModularAssembler.ts";
import { QuaterniusNPCLoader, normalizeToQuaterniusGender } from "./QuaterniusNPCLoader.ts";
import { selectNPCModel, type NPCGender } from "./NPCModelVariety.ts";
import { QuestOfferPanel } from "./QuestOfferPanel.ts";
import type { QuestOfferData } from "./QuestOfferPanel.ts";
import { QuestNotificationManager } from "./QuestNotificationManager.ts";
import { ReputationManager } from "./ReputationManager.ts";
import { QuestLanguageFeedbackPanel } from "./QuestLanguageFeedbackPanel.ts";
import { QuestLanguageFeedbackTracker } from "@shared/language/quest-language-feedback";
import { LanguageProgressTracker } from "./LanguageProgressTracker.ts";
import { extractObjectiveMarkers } from "./QuestMinimapMarkers.ts";
import {
  isFirstPlaythrough,
  isLanguageLearningWorld,
  getTargetLanguage,
  launchOnboarding,
} from "./OnboardingLauncher.ts";
import type { OnboardingLaunchResult } from "./OnboardingLauncher.ts";
import {
  KEY_NPC_INTERACT,
...
import { BabylonPhotographySystem, type SceneObject } from "./BabylonPhotographySystem.ts";
import { BabylonPhotoBookPanel } from "./BabylonPhotoBookPanel.ts";
...
export class BabylonGame {
  ...
  public async init(): Promise<void> {
    try {
      ...
      console.log('[BabylonGame] init: starting initializeEngine...');
      this.updateLoadingScreen('Initializing engine...', 5);
      await this.initializeEngine();
      console.log('[BabylonGame] init: initializeEngine done');
      this.updateLoadingScreen('Setting up scene...', 10);
      console.log('[BabylonGame] init: starting initializeScene...');
      await this.initializeScene();
      console.log('[BabylonGame] init: initializeScene done');
      this.updateLoadingScreen('Initializing systems...', 15);
      console.log('[BabylonGame] init: starting initializeSystems...');
      await this.initializeSystems();
      console.log('[BabylonGame] init: initializeSystems done');
      ...
      console.log('[BabylonGame] init: starting loadWorldData...');
      await this.loadWorldData();
      console.log('[BabylonGame] init: loadWorldData done');
      this.updateLoadingScreen('Generating world...', 30);
      console.log('[BabylonGame] init: starting generateProceduralWorld...');
      await this.generateProceduralWorld();
      console.log('[BabylonGame] init: generateProceduralWorld done');
  ...
  private async initializeScene(): Promise<void> {
    ...
    console.log('[initializeScene] creating Scene...');
    this.scene = new Scene(this.engine);
    console.log('[initializeScene] Scene created, calling setupScene...');
    try {
      await this.setupScene(this.scene, this.canvas, this.worldTheme);
    } catch (e) {
      console.error('[initializeScene] setupScene THREW:', e);
      throw e;
    }
    console.log('[initializeScene] setupScene done');

    // Initialize day/night cycle (drives lighting + sky transitions from game time)
    console.log('[initializeScene] creating DayNightCycle...');
    this.dayNightCycle = new DayNightCycle({
      scene: this.scene,
      timeManager: this.gameTimeManager,
      baseSkyColor: this.worldTheme.skyColor,
    });
    console.log('[initializeScene] DayNightCycle created');

    // Create camera
    console.log('[initializeScene] creating camera...');
    ...
    console.log('[initializeScene] camera + CameraManager done');
  ...
  private async setupScene(scene: Scene, canvas: HTMLCanvasElement, theme: WorldVisualTheme): Promise<void> {
    ...
    console.log('[setupScene] WorldObjectActionManager...');
    ...
    // Lighting
    console.log('[setupScene] creating lights...');
    ...
    console.log('[setupScene] creating sky dome...');
    ...
    this.socializationController = new NPCSocializationController({
      ...
      onStartConversation: async (npc1Id: string, npc2Id: string, topic?: string): Promise<ConversationResult | null> => {
        try {
          ...
          // TODO: Wire to Electron IPC AI bridge when local LLM is available (see ralphy-electron-ai-bridge PRD)
...
result = await SceneLoader.ImportMeshAsync("", npcRootUrl, npcFileName, this.scene);
  ...
  private async fetchMainQuestJournalData(): Promise<void> {
    try {
      // In exported games (file:// protocol or FileDataSource), build journal from local quest data
      if (typeof window !== 'undefined' && (window.location?.protocol === 'file:' || !this.config.authToken)) {
  ...
  private async fetchPortfolioData(): Promise<void> {
    try {
      // In exported games, portfolio starts empty (no server to fetch from)
      if (typeof window !== 'undefined' && (window.location?.protocol === 'file:' || !this.config.authToken)) {
        return;
      }
      const worldId = this.config.worldId;

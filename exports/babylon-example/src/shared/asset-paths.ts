...
export const PLAYER_MODEL_URL = './assets/player/Vincent-frontFacing.babylon';

/** Legacy NPC model (Babylon format) */
export const NPC_DEFAULT_MODEL_URL = './assets/npc/starterAvatars.babylon';

/** Default footstep sound */
export const FOOTSTEP_SOUND_URL = './assets/audio/footstep/stone.mp3';

// ─── Ground textures (absolute paths for client-side loading) ────────────────

export const GROUND_DIFFUSE_URL = './assets/ground/ground.jpg';
export const GROUND_NORMAL_URL = './assets/ground/ground-normal.png';
export const GROUND_HEIGHTMAP_URL = './assets/ground/ground_heightMap.png';

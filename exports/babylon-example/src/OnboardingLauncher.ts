...
import type { GameEventBus } from './GameEventBus.ts';

import type { AssessmentModalConfig } from './AssessmentModalUI.ts';
...
export async function launchOnboarding(
  ...
  try {
    [
      ...
      import('./AssessmentEngine.ts'),
      import('./OnboardingManager.ts'),
      import('./AssessmentModalUI.ts'),

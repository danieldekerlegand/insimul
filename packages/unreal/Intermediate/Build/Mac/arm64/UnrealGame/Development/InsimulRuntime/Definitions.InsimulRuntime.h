...
#define UE_TARGET_NAME CitySample
...
#define INSIMULRUNTIME_API 
#define INSIMULRUNTIME_NON_ATTRIBUTED_API 
...
#define AUDIOCAPTURE_NON_ATTRIBUTED_API 
#define AUDIOCAPTURECORE_API 
#define AUDIOCAPTURECORE_NON_ATTRIBUTED_API 

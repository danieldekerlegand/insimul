...
export const BASE_ITEM_CATALOG: AuditItem[] = [
  ...
  { name: 'Antidote', worldType: 'medieval-fantasy', itemType: 'consumable', objectRole: 'potion', category: 'potion', rarity: 'uncommon', possessable: true },
  ...
  { name: 'Meat Pie', worldType: 'medieval-fantasy', itemType: 'food', objectRole: 'food_plate', category: 'food', rarity: 'common', possessable: true },
  { name: 'Water Flask', worldType: 'medieval-fantasy', itemType: 'drink', objectRole: 'bottle', category: 'drink', rarity: 'common', possessable: true },
  ...
  { name: 'Rope', worldType: 'medieval-fantasy', itemType: 'tool', objectRole: 'rope', category: 'utility', rarity: 'common', possessable: true },
  ...
  { name: 'Iron Ore', worldType: 'medieval-fantasy', itemType: 'material', objectRole: 'ore_chunk', category: 'ore', rarity: 'common', possessable: true },
  ...
  { name: 'EMP Grenade', worldType: 'cyberpunk', itemType: 'weapon', objectRole: 'grenade', category: 'explosive', rarity: 'uncommon', possessable: true },
  { name: 'Neural Stim', worldType: 'cyberpunk', itemType: 'consumable', objectRole: 'syringe', category: 'medical', rarity: 'common', possessable: true },
  { name: 'Med-Hypo', worldType: 'cyberpunk', itemType: 'consumable', objectRole: 'syringe', category: 'medical', rarity: 'common', possessable: true },
  { name: 'Synth-Food Bar', worldType: 'cyberpunk', itemType: 'food', objectRole: 'food_bar', category: 'food', rarity: 'common', possessable: true },
  ...
  { name: 'Credstick', worldType: 'cyberpunk', itemType: 'collectible', objectRole: 'card', category: 'currency', rarity: 'common', possessable: true },
  ...
  { name: 'Energy Cell', worldType: 'sci-fi-space', itemType: 'material', objectRole: 'battery', category: 'ammunition', rarity: 'common', possessable: true },
  { name: 'Emergency Ration', worldType: 'sci-fi-space', itemType: 'food', objectRole: 'food_bar', category: 'food', rarity: 'common', possessable: true },
  { name: 'Oxygen Tank', worldType: 'sci-fi-space', itemType: 'consumable', objectRole: 'tank', category: 'survival', rarity: 'common', possessable: true },
  { name: 'Repair Kit', worldType: 'sci-fi-space', itemType: 'tool', objectRole: 'toolbox', category: 'tool', rarity: 'uncommon', possessable: true },
  { name: 'Medi-Gel', worldType: 'sci-fi-space', itemType: 'consumable', objectRole: 'med_pack', category: 'medical', rarity: 'common', possessable: true },
  { name: 'Star Map Fragment', worldType: 'sci-fi-space', itemType: 'key', objectRole: 'scroll', category: 'key', rarity: 'rare', possessable: true },
  ...
  { name: 'Lasso', worldType: 'western', itemType: 'tool', objectRole: 'rope', category: 'tool', rarity: 'common', possessable: true },
  { name: 'Whiskey', worldType: 'western', itemType: 'drink', objectRole: 'bottle', category: 'drink', rarity: 'common', possessable: true },
  { name: 'Dynamite', worldType: 'western', itemType: 'weapon', objectRole: 'dynamite', category: 'explosive', rarity: 'uncommon', possessable: true },
  ...
  { name: 'Bandage', worldType: 'western', itemType: 'consumable', objectRole: 'med_pack', category: 'medical', rarity: 'common', possessable: true },
  ...
  { name: 'Fiber', worldType: null, itemType: 'material', objectRole: 'spool', category: 'raw_material', rarity: 'common', possessable: true },
  { name: 'Leather', worldType: null, itemType: 'material', objectRole: 'sack', category: 'raw_material', rarity: 'common', possessable: true },
  { name: 'Cloth', worldType: null, itemType: 'material', objectRole: 'sack', category: 'raw_material', rarity: 'common', possessable: true },
  { name: 'Clay', worldType: null, itemType: 'material', objectRole: 'ore_chunk', category: 'raw_material', rarity: 'common', possessable: true },
  { name: 'Glass', worldType: null, itemType: 'material', objectRole: 'bottle', category: 'refined_material', rarity: 'common', possessable: true },

  // Universal refined materials & ores
  { name: 'Iron Ingot', worldType: null, itemType: 'material', objectRole: 'ingot', category: 'refined_material', rarity: 'common', possessable: true },
  { name: 'Steel Ingot', worldType: null, itemType: 'material', objectRole: 'ingot', category: 'refined_material', rarity: 'uncommon', possessable: true },
  { name: 'Silver Ingot', worldType: null, itemType: 'material', objectRole: 'ingot', category: 'refined_material', rarity: 'uncommon', possessable: true },
  { name: 'Gold Ingot', worldType: null, itemType: 'material', objectRole: 'ingot', category: 'refined_material', rarity: 'rare', possessable: true },
  { name: 'Copper Ore', worldType: null, itemType: 'material', objectRole: 'ore_chunk', category: 'ore', rarity: 'common', possessable: true },
  { name: 'Coal', worldType: null, itemType: 'material', objectRole: 'ore_chunk', category: 'fuel', rarity: 'common', possessable: true },
  ...
  { name: 'Shovel', worldType: null, itemType: 'tool', objectRole: 'shovel', category: 'tool', rarity: 'common', possessable: true },
  { name: 'Fishing Rod', worldType: null, itemType: 'tool', objectRole: 'rod', category: 'tool', rarity: 'common', possessable: true },
  { name: 'Sack', worldType: null, itemType: 'tool', objectRole: 'sack', category: 'container', rarity: 'common', possessable: true },
  { name: 'Candle', worldType: null, itemType: 'tool', objectRole: 'candle', category: 'light_source', rarity: 'common', possessable: true },
  ...
  { name: 'Map', worldType: null, itemType: 'key', objectRole: 'scroll', category: 'document', rarity: 'uncommon', possessable: true },
  { name: 'Book', worldType: null, itemType: 'collectible', objectRole: 'book', category: 'document', rarity: 'common', possessable: true },
  { name: 'Letter', worldType: null, itemType: 'quest', objectRole: 'scroll', category: 'document', rarity: 'common', possessable: true },
  { name: 'Coin Purse', worldType: null, itemType: 'collectible', objectRole: 'pouch', category: 'currency', rarity: 'common', possessable: true },

  // Universal food & ingredients
  { name: 'Apple', worldType: null, itemType: 'food', objectRole: 'food_small', category: 'food', rarity: 'common', possessable: true },
  { name: 'Raw Meat', worldType: null, itemType: 'food', objectRole: 'food_plate', category: 'ingredient', rarity: 'common', possessable: true },
  { name: 'Fish', worldType: null, itemType: 'food', objectRole: 'food_plate', category: 'ingredient', rarity: 'common', possessable: true },
  { name: 'Mushroom', worldType: null, itemType: 'food', objectRole: 'food_small', category: 'ingredient', rarity: 'common', possessable: true },
  { name: 'Salt', worldType: null, itemType: 'material', objectRole: 'jar', category: 'ingredient', rarity: 'common', possessable: true },
  ...
  { name: 'Stick', worldType: null, itemType: 'material', objectRole: 'plank', category: 'raw_material', rarity: 'common', possessable: true },
  { name: 'Bone', worldType: null, itemType: 'material', objectRole: 'small_prop', category: 'raw_material', rarity: 'common', possessable: true },
  { name: 'Feather', worldType: null, itemType: 'material', objectRole: 'small_prop', category: 'raw_material', rarity: 'common', possessable: true },
  { name: 'Shell', worldType: null, itemType: 'collectible', objectRole: 'small_prop', category: 'collectible', rarity: 'common', possessable: true },
  ...
  { name: 'Crossbow', worldType: 'medieval-fantasy', itemType: 'weapon', objectRole: 'bow', category: 'ranged_weapon', rarity: 'uncommon', possessable: true },
  { name: 'War Hammer', worldType: 'medieval-fantasy', itemType: 'weapon', objectRole: 'hammer', category: 'melee_weapon', rarity: 'uncommon', possessable: true },
  { name: 'Spear', worldType: 'medieval-fantasy', itemType: 'weapon', objectRole: 'spear', category: 'melee_weapon', rarity: 'common', possessable: true },
  { name: 'Staff', worldType: 'medieval-fantasy', itemType: 'weapon', objectRole: 'staff', category: 'melee_weapon', rarity: 'common', possessable: true },
  ...
  { name: 'Leather Armor', worldType: 'medieval-fantasy', itemType: 'armor', objectRole: 'armor_piece', category: 'light_armor', rarity: 'common', possessable: true },
  { name: 'Plate Armor', worldType: 'medieval-fantasy', itemType: 'armor', objectRole: 'armor_piece', category: 'heavy_armor', rarity: 'rare', possessable: true },
  { name: 'Helmet', worldType: 'medieval-fantasy', itemType: 'armor', objectRole: 'helmet', category: 'head_armor', rarity: 'common', possessable: true },
  { name: 'Arrow', worldType: 'medieval-fantasy', itemType: 'material', objectRole: 'small_prop', category: 'ammunition', rarity: 'common', possessable: true },
  ...
  { name: 'Ale', worldType: 'medieval-fantasy', itemType: 'drink', objectRole: 'goblet', category: 'drink', rarity: 'common', possessable: true },
  { name: 'Wine', worldType: 'medieval-fantasy', itemType: 'drink', objectRole: 'goblet', category: 'drink', rarity: 'uncommon', possessable: true },
  { name: 'Scroll', worldType: 'medieval-fantasy', itemType: 'collectible', objectRole: 'scroll', category: 'document', rarity: 'uncommon', possessable: true },
  ...
  { name: 'Cheese', worldType: null, itemType: 'food', objectRole: 'food_wedge', category: 'food', rarity: 'common', possessable: true },
  { name: 'Egg', worldType: null, itemType: 'food', objectRole: 'food_small', category: 'ingredient', rarity: 'common', possessable: true },
  { name: 'Honey', worldType: null, itemType: 'food', objectRole: 'jar', category: 'food', rarity: 'uncommon', possessable: true },
  { name: 'Berries', worldType: null, itemType: 'food', objectRole: 'food_bowl', category: 'food', rarity: 'common', possessable: true },
  { name: 'Milk', worldType: null, itemType: 'drink', objectRole: 'bottle', category: 'drink', rarity: 'common', possessable: true },
  { name: 'Water Bottle', worldType: null, itemType: 'drink', objectRole: 'bottle', category: 'drink', rarity: 'common', possessable: true },
  { name: 'Flour', worldType: null, itemType: 'material', objectRole: 'sack', category: 'ingredient', rarity: 'common', possessable: true },
  { name: 'Sugar', worldType: null, itemType: 'material', objectRole: 'jar', category: 'ingredient', rarity: 'common', possessable: true },
  { name: 'Oil', worldType: null, itemType: 'material', objectRole: 'bottle', category: 'ingredient', rarity: 'common', possessable: true },

  // Universal materials
  { name: 'Rope Coil', worldType: null, itemType: 'material', objectRole: 'rope', category: 'utility', rarity: 'common', possessable: true },
  { name: 'Nails', worldType: null, itemType: 'material', objectRole: 'small_box', category: 'component', rarity: 'common', possessable: true },
  { name: 'Wax', worldType: null, itemType: 'material', objectRole: 'small_block', category: 'raw_material', rarity: 'common', possessable: true },
  { name: 'Thread', worldType: null, itemType: 'material', objectRole: 'spool', category: 'raw_material', rarity: 'common', possessable: true },
  { name: 'Ink', worldType: null, itemType: 'material', objectRole: 'inkwell', category: 'refined_material', rarity: 'common', possessable: true },
  { name: 'Parchment', worldType: null, itemType: 'material', objectRole: 'scroll', category: 'raw_material', rarity: 'common', possessable: true },

  // Universal tools
  { name: 'Needle', worldType: null, itemType: 'tool', objectRole: 'small_tool', category: 'tool', rarity: 'common', possessable: true },
  { name: 'Saw', worldType: null, itemType: 'tool', objectRole: 'saw', category: 'tool', rarity: 'common', possessable: true },
  { name: 'Bucket', worldType: null, itemType: 'tool', objectRole: 'bucket', category: 'container', rarity: 'common', possessable: true },
  { name: 'Mortar and Pestle', worldType: null, itemType: 'tool', objectRole: 'mortar', category: 'tool', rarity: 'uncommon', possessable: true },

  // Universal collectibles
  { name: 'Flower', worldType: null, itemType: 'collectible', objectRole: 'plant', category: 'collectible', rarity: 'common', possessable: true },
  { name: 'Pendant', worldType: null, itemType: 'collectible', objectRole: 'amulet', category: 'jewelry', rarity: 'uncommon', possessable: true },
  { name: 'Mirror', worldType: null, itemType: 'collectible', objectRole: 'small_prop', category: 'collectible', rarity: 'uncommon', possessable: true },
  { name: 'Dice', worldType: null, itemType: 'collectible', objectRole: 'small_prop', category: 'collectible', rarity: 'common', possessable: true },
  { name: 'Bell', worldType: null, itemType: 'collectible', objectRole: 'bell', category: 'collectible', rarity: 'common', possessable: true },
  ...
  { name: 'Battle Axe', worldType: 'medieval-fantasy', itemType: 'weapon', objectRole: 'axe', category: 'melee_weapon', rarity: 'uncommon', possessable: true },
  { name: 'Mace', worldType: 'medieval-fantasy', itemType: 'weapon', objectRole: 'mace', category: 'melee_weapon', rarity: 'uncommon', possessable: true },
  { name: 'Halberd', worldType: 'medieval-fantasy', itemType: 'weapon', objectRole: 'spear', category: 'melee_weapon', rarity: 'rare', possessable: true },
  { name: 'Enchanted Ring', worldType: 'medieval-fantasy', itemType: 'collectible', objectRole: 'ring', category: 'jewelry', rarity: 'rare', possessable: true },
  { name: 'Cloak', worldType: 'medieval-fantasy', itemType: 'armor', objectRole: 'armor_piece', category: 'light_armor', rarity: 'common', possessable: true },
  { name: 'Gauntlets', worldType: 'medieval-fantasy', itemType: 'armor', objectRole: 'armor_piece', category: 'hand_armor', rarity: 'uncommon', possessable: true },
  { name: 'Holy Water', worldType: 'medieval-fantasy', itemType: 'consumable', objectRole: 'potion', category: 'potion', rarity: 'uncommon', possessable: true },
  ...
  { name: 'Dragon Scale', worldType: 'medieval-fantasy', itemType: 'material', objectRole: 'gemstone', category: 'rare_material', rarity: 'legendary', possessable: true },
  { name: 'Quiver', worldType: 'medieval-fantasy', itemType: 'tool', objectRole: 'quiver', category: 'equipment', rarity: 'common', possessable: true },
  ...
  { name: 'Crystal Ball', worldType: 'medieval-fantasy', itemType: 'collectible', objectRole: 'gemstone', category: 'treasure', rarity: 'epic', possessable: true },
  ...
  { name: 'Stew', worldType: 'medieval-fantasy', itemType: 'food', objectRole: 'food_bowl', category: 'food', rarity: 'common', possessable: true },
  { name: 'Roasted Chicken', worldType: 'medieval-fantasy', itemType: 'food', objectRole: 'food_plate', category: 'food', rarity: 'common', possessable: true },
  ...
  { name: 'Shock Baton', worldType: 'cyberpunk', itemType: 'weapon', objectRole: 'baton', category: 'melee_weapon', rarity: 'common', possessable: true },
  { name: 'Plasma Rifle', worldType: 'cyberpunk', itemType: 'weapon', objectRole: 'rifle', category: 'ranged_weapon', rarity: 'rare', possessable: true },
  { name: 'Nano-Wire', worldType: 'cyberpunk', itemType: 'weapon', objectRole: 'wire_coil', category: 'melee_weapon', rarity: 'rare', possessable: true },
  { name: 'Holo-Shield', worldType: 'cyberpunk', itemType: 'armor', objectRole: 'shield', category: 'shield', rarity: 'uncommon', possessable: true },
  { name: 'Synth-Armor Vest', worldType: 'cyberpunk', itemType: 'armor', objectRole: 'armor_piece', category: 'light_armor', rarity: 'uncommon', possessable: true },
  { name: 'Combat Helmet', worldType: 'cyberpunk', itemType: 'armor', objectRole: 'helmet', category: 'head_armor', rarity: 'uncommon', possessable: true },
  { name: 'Neural Interface', worldType: 'cyberpunk', itemType: 'tool', objectRole: 'small_tool', category: 'implant', rarity: 'epic', possessable: true },
  { name: 'Reflex Booster', worldType: 'cyberpunk', itemType: 'consumable', objectRole: 'syringe', category: 'implant', rarity: 'rare', possessable: true },
  { name: 'Stim Pack', worldType: 'cyberpunk', itemType: 'consumable', objectRole: 'med_pack', category: 'medical', rarity: 'common', possessable: true },
  { name: 'E-Ration', worldType: 'cyberpunk', itemType: 'food', objectRole: 'food_bar', category: 'food', rarity: 'common', possessable: true },
  { name: 'Neon Drink', worldType: 'cyberpunk', itemType: 'drink', objectRole: 'drink_can', category: 'drink', rarity: 'common', possessable: true },
  { name: 'Hacking Spike', worldType: 'cyberpunk', itemType: 'key', objectRole: 'card', category: 'key', rarity: 'uncommon', possessable: true },
  { name: 'ID Chip', worldType: 'cyberpunk', itemType: 'key', objectRole: 'card', category: 'key', rarity: 'rare', possessable: true },
  { name: 'Scrap Metal', worldType: 'cyberpunk', itemType: 'material', objectRole: 'ore_chunk', category: 'raw_material', rarity: 'common', possessable: true },
  { name: 'Circuit Board', worldType: 'cyberpunk', itemType: 'material', objectRole: 'small_prop', category: 'component', rarity: 'common', possessable: true },
  ...
  { name: 'Laser Rifle', worldType: 'sci-fi-space', itemType: 'weapon', objectRole: 'rifle', category: 'ranged_weapon', rarity: 'uncommon', possessable: true },
  { name: 'Stun Baton', worldType: 'sci-fi-space', itemType: 'weapon', objectRole: 'baton', category: 'melee_weapon', rarity: 'common', possessable: true },
  { name: 'Photon Blade', worldType: 'sci-fi-space', itemType: 'weapon', objectRole: 'sword', category: 'melee_weapon', rarity: 'epic', possessable: true },
  { name: 'EVA Suit', worldType: 'sci-fi-space', itemType: 'armor', objectRole: 'armor_piece', category: 'heavy_armor', rarity: 'rare', possessable: true },
  { name: 'Shield Generator', worldType: 'sci-fi-space', itemType: 'armor', objectRole: 'shield', category: 'shield', rarity: 'rare', possessable: true },
  { name: 'Bio-Gel Pack', worldType: 'sci-fi-space', itemType: 'consumable', objectRole: 'med_pack', category: 'medical', rarity: 'uncommon', possessable: true },
  { name: 'Stim Injector', worldType: 'sci-fi-space', itemType: 'consumable', objectRole: 'syringe', category: 'medical', rarity: 'common', possessable: true },
  { name: 'Nutrient Paste', worldType: 'sci-fi-space', itemType: 'food', objectRole: 'food_bar', category: 'food', rarity: 'common', possessable: true },
  { name: 'Protein Bar', worldType: 'sci-fi-space', itemType: 'food', objectRole: 'food_bar', category: 'food', rarity: 'common', possessable: true },
  { name: 'Data Crystal', worldType: 'sci-fi-space', itemType: 'key', objectRole: 'gemstone', category: 'data', rarity: 'rare', possessable: true },
  { name: 'Access Keycard', worldType: 'sci-fi-space', itemType: 'key', objectRole: 'card', category: 'key', rarity: 'uncommon', possessable: true },
  { name: 'Titanium Alloy', worldType: 'sci-fi-space', itemType: 'material', objectRole: 'ingot', category: 'refined_material', rarity: 'uncommon', possessable: true },
  { name: 'Quantum Chip', worldType: 'sci-fi-space', itemType: 'material', objectRole: 'small_prop', category: 'component', rarity: 'rare', possessable: true },
  { name: 'Scanner', worldType: 'sci-fi-space', itemType: 'tool', objectRole: 'small_tool', category: 'tool', rarity: 'uncommon', possessable: true },
  { name: 'Multi-Tool', worldType: 'sci-fi-space', itemType: 'tool', objectRole: 'small_tool', category: 'tool', rarity: 'common', possessable: true },

  // Western (migration 018)
  { name: 'Rifle', worldType: 'western', itemType: 'weapon', objectRole: 'rifle', category: 'ranged_weapon', rarity: 'uncommon', possessable: true },
  { name: 'Shotgun', worldType: 'western', itemType: 'weapon', objectRole: 'rifle', category: 'ranged_weapon', rarity: 'uncommon', possessable: true },
  { name: 'Bowie Knife', worldType: 'western', itemType: 'weapon', objectRole: 'dagger', category: 'melee_weapon', rarity: 'common', possessable: true },
  { name: 'Leather Duster', worldType: 'western', itemType: 'armor', objectRole: 'armor_piece', category: 'light_armor', rarity: 'common', possessable: true },
  { name: 'Cowboy Hat', worldType: 'western', itemType: 'armor', objectRole: 'helmet', category: 'head_armor', rarity: 'common', possessable: true },
  { name: 'Bullets', worldType: 'western', itemType: 'material', objectRole: 'small_box', category: 'ammunition', rarity: 'common', possessable: true },
  { name: 'Moonshine', worldType: 'western', itemType: 'drink', objectRole: 'bottle', category: 'drink', rarity: 'uncommon', possessable: true },
  { name: 'Beef Jerky', worldType: 'western', itemType: 'food', objectRole: 'food_small', category: 'food', rarity: 'common', possessable: true },
  { name: 'Canned Beans', worldType: 'western', itemType: 'food', objectRole: 'can', category: 'food', rarity: 'common', possessable: true },
  { name: 'Pocket Watch', worldType: 'western', itemType: 'collectible', objectRole: 'small_prop', category: 'jewelry', rarity: 'uncommon', possessable: true },
  { name: 'Harmonica', worldType: 'western', itemType: 'collectible', objectRole: 'small_prop', category: 'collectible', rarity: 'common', possessable: true },
  { name: 'Gold Nugget', worldType: 'western', itemType: 'material', objectRole: 'ore_chunk', category: 'ore', rarity: 'rare', possessable: true },
  { name: 'Tobacco Pouch', worldType: 'western', itemType: 'consumable', objectRole: 'pouch', category: 'consumable', rarity: 'common', possessable: true },
  ...
  { name: 'Saddle', worldType: 'western', itemType: 'tool', objectRole: 'saddle', category: 'equipment', rarity: 'uncommon', possessable: false },
  ...
  { name: 'Bronze Sword', worldType: 'historical-ancient', itemType: 'weapon', objectRole: 'sword', category: 'melee_weapon', rarity: 'common', possessable: true },
  { name: 'Javelin', worldType: 'historical-ancient', itemType: 'weapon', objectRole: 'spear', category: 'ranged_weapon', rarity: 'common', possessable: true },
  { name: 'Gladius', worldType: 'historical-ancient', itemType: 'weapon', objectRole: 'sword', category: 'melee_weapon', rarity: 'uncommon', possessable: true },
  { name: 'Round Shield', worldType: 'historical-ancient', itemType: 'armor', objectRole: 'shield', category: 'shield', rarity: 'common', possessable: true },
  { name: 'Toga', worldType: 'historical-ancient', itemType: 'armor', objectRole: 'armor_piece', category: 'light_armor', rarity: 'common', possessable: true },
  { name: 'Laurel Wreath', worldType: 'historical-ancient', itemType: 'collectible', objectRole: 'crown', category: 'treasure', rarity: 'rare', possessable: true },
  ...
  { name: 'Olive Oil', worldType: 'historical-ancient', itemType: 'food', objectRole: 'bottle', category: 'ingredient', rarity: 'common', possessable: true },
  { name: 'Flatbread', worldType: 'historical-ancient', itemType: 'food', objectRole: 'food_loaf', category: 'food', rarity: 'common', possessable: true },
  { name: 'Wine Jug', worldType: 'historical-ancient', itemType: 'drink', objectRole: 'bottle', category: 'drink', rarity: 'common', possessable: true },
  { name: 'Papyrus Scroll', worldType: 'historical-ancient', itemType: 'collectible', objectRole: 'scroll', category: 'document', rarity: 'uncommon', possessable: true },
  { name: 'Ancient Coin', worldType: 'historical-ancient', itemType: 'collectible', objectRole: 'small_prop', category: 'currency', rarity: 'common', possessable: true },
  ...
  { name: 'Pipe Wrench', worldType: 'post-apocalyptic', itemType: 'weapon', objectRole: 'hammer', category: 'melee_weapon', rarity: 'common', possessable: true },
  { name: 'Makeshift Rifle', worldType: 'post-apocalyptic', itemType: 'weapon', objectRole: 'rifle', category: 'ranged_weapon', rarity: 'uncommon', possessable: true },
  { name: 'Spiked Bat', worldType: 'post-apocalyptic', itemType: 'weapon', objectRole: 'baton', category: 'melee_weapon', rarity: 'common', possessable: true },
  { name: 'Scrap Armor', worldType: 'post-apocalyptic', itemType: 'armor', objectRole: 'armor_piece', category: 'heavy_armor', rarity: 'common', possessable: true },
  { name: 'Gas Mask', worldType: 'post-apocalyptic', itemType: 'armor', objectRole: 'helmet', category: 'head_armor', rarity: 'uncommon', possessable: true },
  { name: 'Canned Food', worldType: 'post-apocalyptic', itemType: 'food', objectRole: 'can', category: 'food', rarity: 'common', possessable: true },
  { name: 'Purified Water', worldType: 'post-apocalyptic', itemType: 'drink', objectRole: 'bottle', category: 'drink', rarity: 'uncommon', possessable: true },
  { name: 'Rad-Away', worldType: 'post-apocalyptic', itemType: 'consumable', objectRole: 'med_pack', category: 'medical', rarity: 'uncommon', possessable: true },
  { name: 'Duct Tape', worldType: 'post-apocalyptic', itemType: 'material', objectRole: 'spool', category: 'component', rarity: 'common', possessable: true },
  { name: 'Fuel Can', worldType: 'post-apocalyptic', itemType: 'material', objectRole: 'barrel', category: 'fuel', rarity: 'rare', possessable: true },
  { name: 'Survival Axe', worldType: 'post-apocalyptic', itemType: 'tool', objectRole: 'axe', category: 'tool', rarity: 'common', possessable: true },
  { name: 'Geiger Counter', worldType: 'post-apocalyptic', itemType: 'tool', objectRole: 'small_tool', category: 'tool', rarity: 'rare', possessable: true },
  ...
  { name: 'Flintlock Pistol', worldType: 'tropical-pirate', itemType: 'weapon', objectRole: 'pistol', category: 'ranged_weapon', rarity: 'uncommon', possessable: true },
  { name: 'Boarding Axe', worldType: 'tropical-pirate', itemType: 'weapon', objectRole: 'axe', category: 'melee_weapon', rarity: 'common', possessable: true },
  { name: 'Pirate Hat', worldType: 'tropical-pirate', itemType: 'armor', objectRole: 'helmet', category: 'head_armor', rarity: 'common', possessable: true },
  { name: 'Rum', worldType: 'tropical-pirate', itemType: 'drink', objectRole: 'bottle', category: 'drink', rarity: 'common', possessable: true },
  { name: 'Coconut', worldType: 'tropical-pirate', itemType: 'food', objectRole: 'food_small', category: 'food', rarity: 'common', possessable: true },
  { name: 'Banana', worldType: 'tropical-pirate', itemType: 'food', objectRole: 'food_small', category: 'food', rarity: 'common', possessable: true },
  { name: 'Treasure Map', worldType: 'tropical-pirate', itemType: 'quest', objectRole: 'scroll', category: 'document', rarity: 'legendary', possessable: true },
  { name: 'Gold Doubloon', worldType: 'tropical-pirate', itemType: 'collectible', objectRole: 'small_prop', category: 'currency', rarity: 'uncommon', possessable: true },
  { name: 'Pearl', worldType: 'tropical-pirate', itemType: 'collectible', objectRole: 'gemstone', category: 'gemstone', rarity: 'rare', possessable: true },
  { name: 'Spyglass', worldType: 'tropical-pirate', itemType: 'tool', objectRole: 'small_tool', category: 'tool', rarity: 'uncommon', possessable: true },
  { name: 'Compass', worldType: 'tropical-pirate', itemType: 'tool', objectRole: 'small_tool', category: 'tool', rarity: 'uncommon', possessable: true },
  { name: 'Fishing Net', worldType: 'tropical-pirate', itemType: 'tool', objectRole: 'rope', category: 'tool', rarity: 'common', possessable: true },
  ...
  { name: 'Steam Pistol', worldType: 'steampunk', itemType: 'weapon', objectRole: 'pistol', category: 'ranged_weapon', rarity: 'common', possessable: true },
  { name: 'Clockwork Sword', worldType: 'steampunk', itemType: 'weapon', objectRole: 'sword', category: 'melee_weapon', rarity: 'rare', possessable: true },
  { name: 'Aether Goggles', worldType: 'steampunk', itemType: 'armor', objectRole: 'helmet', category: 'head_armor', rarity: 'uncommon', possessable: true },
  { name: 'Reinforced Corset', worldType: 'steampunk', itemType: 'armor', objectRole: 'armor_piece', category: 'light_armor', rarity: 'uncommon', possessable: true },
  { name: 'Clockwork Key', worldType: 'steampunk', itemType: 'key', objectRole: 'key', category: 'key', rarity: 'uncommon', possessable: true },
  { name: 'Gear Set', worldType: 'steampunk', itemType: 'material', objectRole: 'small_prop', category: 'component', rarity: 'common', possessable: true },
  { name: 'Steam Core', worldType: 'steampunk', itemType: 'material', objectRole: 'battery', category: 'component', rarity: 'uncommon', possessable: true },
  { name: 'Tea', worldType: 'steampunk', itemType: 'drink', objectRole: 'goblet', category: 'drink', rarity: 'common', possessable: true },
  { name: 'Scone', worldType: 'steampunk', itemType: 'food', objectRole: 'food_small', category: 'food', rarity: 'common', possessable: true },
  { name: 'Blowtorch', worldType: 'steampunk', itemType: 'tool', objectRole: 'blowtorch', category: 'tool', rarity: 'common', possessable: true },
  { name: 'Pocket Chronometer', worldType: 'steampunk', itemType: 'collectible', objectRole: 'small_prop', category: 'jewelry', rarity: 'uncommon', possessable: true },
  { name: 'Monocle', worldType: 'steampunk', itemType: 'collectible', objectRole: 'small_prop', category: 'collectible', rarity: 'common', possessable: true },
  ...
  { name: 'Smartphone', worldType: 'modern-realistic', itemType: 'tool', objectRole: 'small_prop', category: 'tool', rarity: 'uncommon', possessable: true },
  { name: 'Backpack', worldType: 'modern-realistic', itemType: 'tool', objectRole: 'sack', category: 'equipment', rarity: 'common', possessable: true },
  { name: 'First Aid Kit', worldType: 'modern-realistic', itemType: 'consumable', objectRole: 'toolbox', category: 'medical', rarity: 'uncommon', possessable: true },
  { name: 'Energy Drink', worldType: 'modern-realistic', itemType: 'drink', objectRole: 'drink_can', category: 'drink', rarity: 'common', possessable: true },
  { name: 'Coffee', worldType: 'modern-realistic', itemType: 'drink', objectRole: 'goblet', category: 'drink', rarity: 'common', possessable: true },
  { name: 'Sandwich', worldType: 'modern-realistic', itemType: 'food', objectRole: 'food_plate', category: 'food', rarity: 'common', possessable: true },
  { name: 'Pizza Slice', worldType: 'modern-realistic', itemType: 'food', objectRole: 'food_plate', category: 'food', rarity: 'common', possessable: true },
  { name: 'Notebook', worldType: 'modern-realistic', itemType: 'collectible', objectRole: 'book', category: 'document', rarity: 'common', possessable: true },
  { name: 'Wallet', worldType: 'modern-realistic', itemType: 'collectible', objectRole: 'pouch', category: 'currency', rarity: 'common', possessable: true },
  { name: 'Umbrella', worldType: 'modern-realistic', itemType: 'tool', objectRole: 'staff', category: 'tool', rarity: 'common', possessable: true },
  { name: 'Flashlight', worldType: 'modern-realistic', itemType: 'tool', objectRole: 'lantern', category: 'light_source', rarity: 'common', possessable: true },
  { name: 'Sunglasses', worldType: 'modern-realistic', itemType: 'collectible', objectRole: 'small_prop', category: 'collectible', rarity: 'common', possessable: true },
  { name: 'Headphones', worldType: 'modern-realistic', itemType: 'collectible', objectRole: 'small_prop', category: 'collectible', rarity: 'uncommon', possessable: true },
  { name: 'USB Drive', worldType: 'modern-realistic', itemType: 'key', objectRole: 'card', category: 'data', rarity: 'uncommon', possessable: true },
  { name: 'Battery', worldType: 'modern-realistic', itemType: 'material', objectRole: 'battery', category: 'component', rarity: 'common', possessable: true },
];
...
export const EXISTING_ASSETS: Record<string, { path: string; format: 'gltf' | 'glb' }> = {
  ...
  'boulder_01': { path: 'polyhaven/models/boulder_01.gltf', format: 'gltf' },
  'utility_box_01': { path: 'polyhaven/models/utility_box_01.gltf', format: 'gltf' },
  'potted_plant_02': { path: 'polyhaven/models/potted_plant_02.gltf', format: 'gltf' },

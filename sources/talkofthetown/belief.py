    ...
    def get_facet_to_this_belief_of_type(self, feature_type):
        ...
        # queries regarding binned skin color and age
            ...
            if self.age.exact in (0, 1):
                ...
                (self.age.exact and self.age.exact in range(4, 10)) or
                str(self.age.approximate) == '00s'
            ):
                return 'young'
            elif (
                (self.age.exact and self.age.exact in range(10, 13))
            ):
                return 'preteen'
            elif (
                (self.age.exact and self.age.exact in range(13, 20)) or
                str(self.age.approximate) == '10s'
            ):
                return 'teenage'
            elif (
                (self.age.exact and self.age.exact in range(20, 26))
            ):
                return 'young adult'
            elif (
                (self.age.exact and self.age.exact in range(25, 45)) or
                str(self.age.approximate) in ('20s', '30s', '40s')
            ):
                return 'adult'
            elif (
                (self.age.exact and self.age.exact in range(45, 65)) or
                str(self.age.approximate) == '50s'
            ):
                return 'middle-aged'
            elif (
                (self.age.exact and self.age.exact in range(65, 75)) or

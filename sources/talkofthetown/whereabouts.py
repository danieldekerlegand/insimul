class Whereabouts(object):
    ...
    def __str__(self):
        ...
        return "The whereabouts of {} over the course of {} life".format(
            self.person.name, self.person.possessive
        )
...
class Whereabout(object):
    ...
    def __init__(self, person, occasion):
        ...
        self.date = person.game.date
        self.ordinal_date = person.game.ordinal_date
        self.time_of_day = person.game.time_of_day
    ...
    def __str__(self):
        ...
        if self.occasion == 'work':
            ...
            return "At {} home ({}) on the {}".format(
                self.person.possessive, self.location.address,
                self.date[0].lower()+self.date[1:]
            )

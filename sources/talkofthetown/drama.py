class StoryRecognizer(object):
    ...
    def __str__(self):
        ...
        return "A story-recognition module for the town of {town_name}".format(town_name=self.simulation.city.name)
    ...
    def _excavate_unrequited_love_cases(self):
        ...
        for first_person in self.simulation.city.residents:
    ...
    def _excavate_extramarital_romantic_interests(self):
        ...
        for person in self.simulation.city.residents:
    ...
    def _excavate_business_owner_rivalries(self):
        ...
        for company in self.simulation.city.companies:
            for rival_company in self.simulation.city.businesses_of_type(business_type=company.__class__.__name__):

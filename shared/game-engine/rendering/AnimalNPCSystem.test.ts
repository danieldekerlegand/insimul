...
import { pickRandom, isTooClose, randomWanderTarget, getSpeciesConfigs } from '/game-engine/rendering/AnimalNPCSystem';
import type { AnimalSpecies } from '/game-engine/rendering/AnimalNPCSystem';

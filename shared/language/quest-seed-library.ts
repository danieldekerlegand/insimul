...
export const QUEST_SEEDS: QuestSeed[] = [
  ...
  // ── Numbers & Counting ─────────────────────────────────────────────────
  {
    ...
    difficulty: 'beginner',
    params: [
      { name: 'businessName', type: 'string', description: 'Shop to visit', defaultValue: 'the shop' },
      { name: 'ownerName', type: 'string', description: 'Shop owner NPC' },
      { name: 'itemCount', type: 'number', description: 'Items to count', defaultValue: 5 },
    ],
    titleTemplate: 'Counting at {{businessName}}',
    descriptionTemplate: 'Visit {{businessName}} and help {{ownerName}} count inventory. Report the numbers in {{targetLanguage}} (1–10).',
    questType: 'vocabulary',
    objectiveTemplates: [
      { type: 'visit_location', descriptionTemplate: 'Visit {{businessName}}', countTemplate: 1 },
      { type: 'complete_conversation', descriptionTemplate: 'Count {{itemCount}} items with {{ownerName}} and report totals', countTemplate: 1 },
      { type: 'use_vocabulary', descriptionTemplate: 'Use {{itemCount}} number words (1–10) in {{targetLanguage}}', countTemplate: '{{itemCount}}' },
    ],
    completionCriteria: { type: 'all_objectives' },
    baseXp: 25,
    tags: ['numbers', 'counting', 'vocabulary', 'beginner', 'business'],
  },
  {
    id: 'market_prices',
    name: 'Market Prices',
    ...
    params: [
      { name: 'businessName', type: 'string', description: 'Shop to visit', defaultValue: 'the shop' },
      { name: 'ownerName', type: 'string', description: 'Shop owner NPC' },
      { name: 'priceCount', type: 'number', description: 'Prices to ask about', defaultValue: 3 },
    ],
    titleTemplate: 'Prices at {{businessName}}',
    descriptionTemplate: 'Ask {{ownerName}} about prices at {{businessName}}. Remember and report {{priceCount}} prices correctly in {{targetLanguage}} (10–100).',
    questType: 'vocabulary',
    objectiveTemplates: [
      { type: 'visit_location', descriptionTemplate: 'Visit {{businessName}}', countTemplate: 1 },
      { type: 'complete_conversation', descriptionTemplate: 'Ask {{ownerName}} for {{priceCount}} item prices', countTemplate: '{{priceCount}}' },
      { type: 'use_vocabulary', descriptionTemplate: 'Use number vocabulary (10–100) to discuss prices', countTemplate: '{{priceCount}}' },
    ],
    completionCriteria: { type: 'all_objectives' },
    baseXp: 35,
    tags: ['numbers', 'prices', 'vocabulary', 'intermediate', 'business'],
  },
  {
    id: 'make_change',
    name: 'Make Change',
    ...
    difficulty: 'intermediate',
    params: [
      { name: 'businessName', type: 'string', description: 'Shop to buy from', defaultValue: 'the shop' },
      { name: 'ownerName', type: 'string', description: 'Shop owner NPC' },
      { name: 'itemCount', type: 'number', description: 'Items to purchase', defaultValue: 2 },
    ],
    titleTemplate: 'Making Change at {{businessName}}',
    descriptionTemplate: 'Buy {{itemCount}} items from {{ownerName}} at {{businessName}}. Pay and verify your change using number vocabulary in {{targetLanguage}}.',
    questType: 'vocabulary',
    objectiveTemplates: [
      { type: 'visit_location', descriptionTemplate: 'Visit {{businessName}}', countTemplate: 1 },
      { type: 'haggle_price', descriptionTemplate: 'Purchase {{itemCount}} items from {{ownerName}} and verify change', countTemplate: '{{itemCount}}' },
      { type: 'use_vocabulary', descriptionTemplate: 'Use number and money vocabulary to verify amounts', countTemplate: 4 },
    ],
    completionCriteria: { type: 'all_objectives' },
    baseXp: 35,
    tags: ['numbers', 'money', 'arithmetic', 'intermediate', 'business'],
  },
  {
    id: 'house_numbers',
    name: 'House Numbers',
    ...
    difficulty: 'beginner',
    params: [
      { name: 'npcName', type: 'string', description: 'NPC giving directions' },
      { name: 'locationCount', type: 'number', description: 'Buildings to find', defaultValue: 3 },
    ],
    titleTemplate: 'Find the Address ({{locationCount}} buildings)',
    descriptionTemplate: '{{npcName}} gives you building addresses in {{targetLanguage}}. Find {{locationCount}} buildings by their number.',
    questType: 'vocabulary',
    objectiveTemplates: [
      { type: 'talk_to_npc', descriptionTemplate: 'Get address numbers from {{npcName}} in {{targetLanguage}}', countTemplate: 1 },
      { type: 'visit_location', descriptionTemplate: 'Find {{locationCount}} buildings by their address number', countTemplate: '{{locationCount}}' },
      { type: 'use_vocabulary', descriptionTemplate: 'Use number words to confirm addresses', countTemplate: '{{locationCount}}' },
    ],
    completionCriteria: { type: 'all_objectives' },
    baseXp: 25,
    tags: ['numbers', 'navigation', 'vocabulary', 'beginner'],
  },
  {
    id: 'time_meeting',
    name: 'Meet Me at the Shop',
    category: 'numbers',
    difficulty: 'intermediate',
    params: [
      { name: 'npcName', type: 'string', description: 'NPC to meet' },
      { name: 'businessName', type: 'string', description: 'Meeting place', defaultValue: 'the bakery' },
      { name: 'timeCount', type: 'number', description: 'Time-telling exercises', defaultValue: 2 },
    ],
    titleTemplate: 'Meet {{npcName}} on Time',
    descriptionTemplate: '{{npcName}} tells you meeting times in {{targetLanguage}}. Arrive at {{businessName}} at the right time and schedule {{timeCount}} follow-up meetings.',
    questType: 'vocabulary',
    objectiveTemplates: [
      { type: 'visit_location', descriptionTemplate: 'Arrive at {{businessName}} at the time {{npcName}} specified', countTemplate: 1 },
      { type: 'complete_conversation', descriptionTemplate: 'Schedule {{timeCount}} meetings using time vocabulary', countTemplate: '{{timeCount}}' },
      { type: 'use_vocabulary', descriptionTemplate: 'Use time and number words in {{targetLanguage}}', countTemplate: 4 },
    ],
    completionCriteria: { type: 'all_objectives' },
    baseXp: 35,
    tags: ['numbers', 'time', 'scheduling', 'intermediate', 'business'],
  },
  {
    id: 'price_comparison',
    ...
    difficulty: 'intermediate',
    params: [
      { name: 'shopCount', type: 'number', description: 'Shops to compare', defaultValue: 3 },
      { name: 'npcName', type: 'string', description: 'NPC who wants the best price' },
    ],
    titleTemplate: 'Best Deal in Town ({{shopCount}} shops)',
    descriptionTemplate: '{{npcName}} needs the best price. Visit {{shopCount}} shops, compare prices in {{targetLanguage}}, and report which shop has the best deal.',
    questType: 'vocabulary',
    objectiveTemplates: [
      { type: 'visit_location', descriptionTemplate: 'Visit {{shopCount}} shops to compare prices', countTemplate: '{{shopCount}}' },
      { type: 'use_vocabulary', descriptionTemplate: 'Use number and comparison vocabulary (more, less, cheaper, expensive)', countTemplate: 6 },
      { type: 'talk_to_npc', descriptionTemplate: 'Report the best price to {{npcName}}', countTemplate: 1 },
    ],
    completionCriteria: { type: 'all_objectives' },
    baseXp: 40,
    tags: ['numbers', 'prices', 'comparison', 'intermediate', 'business'],
  },
  {
    id: 'large_numbers',
    name: 'Big Numbers',
    ...
    difficulty: 'advanced',
    params: [
      { name: 'businessName', type: 'string', description: 'Business with large inventory', defaultValue: 'the warehouse' },
      { name: 'ownerName', type: 'string', description: 'Business owner NPC' },
      { name: 'wordCount', type: 'number', description: 'Large number words to use', defaultValue: 5 },
    ],
    titleTemplate: 'Big Numbers at {{businessName}}',
    descriptionTemplate: 'Help {{ownerName}} at {{businessName}} with large quantities. Use numbers 100–1000 and ordinals in {{targetLanguage}}.',
    questType: 'vocabulary',
    objectiveTemplates: [
      { type: 'visit_location', descriptionTemplate: 'Visit {{businessName}}', countTemplate: 1 },
      { type: 'complete_conversation', descriptionTemplate: 'Discuss large quantities and order numbers with {{ownerName}}', countTemplate: 1 },
      { type: 'use_vocabulary', descriptionTemplate: 'Use {{wordCount}} large number and ordinal words (100–1000, first, second, etc.)', countTemplate: '{{wordCount}}' },
    ],
    completionCriteria: { type: 'all_objectives' },
    baseXp: 45,
    tags: ['numbers', 'ordinals', 'vocabulary', 'advanced', 'business'],
  },
  ...
  // ── Customer Service ─────────────────────────────────────────────────────
  {
    ...
    difficulty: 'beginner',
    params: [
      { name: 'businessName', type: 'string', description: 'Business name', defaultValue: 'the shop' },
      { name: 'ownerName', type: 'string', description: 'Shop owner NPC' },
      { name: 'itemName', type: 'string', description: 'Item to return', defaultValue: 'item' },
    ],
    titleTemplate: 'Returning the {{itemName}} at {{businessName}}',
    descriptionTemplate: 'You bought the wrong {{itemName}} at {{businessName}}. Talk to {{ownerName}} to explain the problem and request a refund in {{targetLanguage}}.',
    questType: 'conversation',
    objectiveTemplates: [
      { type: 'visit_location', descriptionTemplate: 'Visit {{businessName}}', countTemplate: 1 },
      { type: 'talk_to_npc', descriptionTemplate: 'Talk to {{ownerName}} about the return', countTemplate: 1 },
      { type: 'complete_conversation', descriptionTemplate: 'Explain the problem and request a refund from {{ownerName}}', countTemplate: 1 },
      { type: 'use_vocabulary', descriptionTemplate: 'Use 3 return/exchange vocabulary words', countTemplate: 3 },
    ],
    completionCriteria: { type: 'conversation_turns', requiredTurns: 3 },
    baseXp: 25,
    tags: ['customer_service', 'return', 'conversation', 'beginner', 'business'],
  },
  {
    ...
    difficulty: 'intermediate',
    params: [
      { name: 'businessName', type: 'string', description: 'Business name', defaultValue: 'the inn' },
      { name: 'ownerName', type: 'string', description: 'Business owner NPC' },
    ],
    titleTemplate: 'Complaint at {{businessName}}',
    descriptionTemplate: 'The service at {{businessName}} was unsatisfactory. Politely but firmly complain to {{ownerName}} in {{targetLanguage}}.',
    questType: 'conversation',
    objectiveTemplates: [
      { type: 'visit_location', descriptionTemplate: 'Visit {{businessName}}', countTemplate: 1 },
      { type: 'complete_conversation', descriptionTemplate: 'Politely explain your complaint to {{ownerName}}', countTemplate: 1 },
      { type: 'use_vocabulary', descriptionTemplate: 'Use 4 polite complaint phrases', countTemplate: 4 },
    ],
    completionCriteria: { type: 'conversation_turns', requiredTurns: 4 },
    baseXp: 40,
    tags: ['customer_service', 'complaint', 'conversation', 'intermediate', 'business'],
  },
  {
    ...
    difficulty: 'intermediate',
    params: [
      { name: 'businessName', type: 'string', description: 'Inn or restaurant name', defaultValue: 'the restaurant' },
      { name: 'ownerName', type: 'string', description: 'Staff NPC' },
    ],
    titleTemplate: 'Reservation at {{businessName}}',
    descriptionTemplate: 'Make a reservation at {{businessName}} by talking to {{ownerName}}. Specify the date, time, and party size in {{targetLanguage}}.',
    questType: 'conversation',
    objectiveTemplates: [
      { type: 'visit_location', descriptionTemplate: 'Visit {{businessName}}', countTemplate: 1 },
      { type: 'talk_to_npc', descriptionTemplate: 'Speak to {{ownerName}} about a reservation', countTemplate: 1 },
      { type: 'complete_conversation', descriptionTemplate: 'Make a reservation specifying date, time, and party size', countTemplate: 1 },
      { type: 'use_vocabulary', descriptionTemplate: 'Use 4 time and date expressions', countTemplate: 4 },
    ],
    completionCriteria: { type: 'conversation_turns', requiredTurns: 4 },
    baseXp: 40,
    tags: ['customer_service', 'reservation', 'conversation', 'intermediate', 'business'],
  },
  {
    ...
    params: [
      { name: 'businessName', type: 'string', description: 'Shop name', defaultValue: 'the shop' },
      { name: 'ownerName', type: 'string', description: 'Shopkeeper NPC' },
    ],
    titleTemplate: 'Recommendations at {{businessName}}',
    descriptionTemplate: 'Visit {{businessName}} and ask {{ownerName}} for recommendations. Describe your preferences and make a decision in {{targetLanguage}}.',
    questType: 'conversation',
    objectiveTemplates: [
      { type: 'visit_location', descriptionTemplate: 'Visit {{businessName}}', countTemplate: 1 },
      { type: 'complete_conversation', descriptionTemplate: 'Ask {{ownerName}} for recommendations and describe preferences', countTemplate: 1 },
      { type: 'use_vocabulary', descriptionTemplate: 'Use 5 preference and comparison words', countTemplate: 5 },
    ],
    completionCriteria: { type: 'conversation_turns', requiredTurns: 5 },
    baseXp: 40,
    tags: ['customer_service', 'recommendations', 'conversation', 'intermediate', 'business'],
  },
  {
    id: 'customer_urgent',
    name: 'I Need This Urgently',
    category: 'customer_service',
    difficulty: 'advanced',
    params: [
      { name: 'businessName', type: 'string', description: 'Business name', defaultValue: 'the workshop' },
      { name: 'ownerName', type: 'string', description: 'Staff NPC' },
    ],
    titleTemplate: 'Urgent Request at {{businessName}}',
    descriptionTemplate: 'You need something done quickly at {{businessName}}. Communicate the urgency to {{ownerName}} while remaining polite in {{targetLanguage}}.',
    questType: 'conversation',
    objectiveTemplates: [
      { type: 'visit_location', descriptionTemplate: 'Visit {{businessName}}', countTemplate: 1 },
      { type: 'complete_conversation', descriptionTemplate: 'Explain the urgency to {{ownerName}} while staying polite', countTemplate: 1 },
      { type: 'use_vocabulary', descriptionTemplate: 'Use 5 urgency and polite insistence phrases', countTemplate: 5 },
    ],
    completionCriteria: { type: 'conversation_turns', requiredTurns: 5 },
    baseXp: 55,
    tags: ['customer_service', 'urgency', 'conversation', 'advanced', 'business'],
  },
  ...
  // ── Storytelling & Narrative ────────────────────────────────────────────
  {
    ...
    difficulty: 'intermediate',
    params: [
      { name: 'npcCount', type: 'number', description: 'NPCs in the story circle', defaultValue: 3 },
      { name: 'turns', type: 'number', description: 'Story segments to contribute', defaultValue: 3 },
      { name: 'wordCount', type: 'number', description: 'Sequencing/descriptive words to use', defaultValue: 6 },
    ],
    titleTemplate: 'The Story Circle',
    descriptionTemplate: 'Join {{npcCount}} NPCs in a collaborative storytelling session. Contribute {{turns}} story segments using sequencing words and descriptive vocabulary in {{targetLanguage}}.',
    questType: 'storytelling',
    objectiveTemplates: [
      { type: 'complete_conversation', descriptionTemplate: 'Contribute {{turns}} story segments to the collaborative tale', countTemplate: '{{turns}}' },
      { type: 'use_vocabulary', descriptionTemplate: 'Use {{wordCount}} sequencing and descriptive words (first, then, finally, beautiful, etc.)', countTemplate: '{{wordCount}}' },
    ],
    completionCriteria: { type: 'conversation_turns', requiredTurns: 6 },
    baseXp: 35,
    tags: ['storytelling', 'narrative', 'past_tense', 'sequencing', 'intermediate'],
  },
  {
    id: 'local_legend',
    name: 'Local Legend',
    ...
    difficulty: 'advanced',
    params: [
      { name: 'storytellerName', type: 'string', description: 'NPC who tells the folk tale' },
      { name: 'listenerName', type: 'string', description: 'NPC to retell the story to' },
      { name: 'questionCount', type: 'number', description: 'Comprehension questions', defaultValue: 3 },
      { name: 'wordCount', type: 'number', description: 'Past tense and emotional words', defaultValue: 5 },
    ],
    titleTemplate: 'The Legend of {{storytellerName}}',
    descriptionTemplate: 'Listen to {{storytellerName}} tell a folk tale in {{targetLanguage}}, then retell it to {{listenerName}} using past tense and emotional vocabulary.',
    questType: 'storytelling',
    objectiveTemplates: [
      { type: 'listening_comprehension', descriptionTemplate: 'Listen to {{storytellerName}}\'s folk tale and answer {{questionCount}} comprehension questions', countTemplate: '{{questionCount}}' },
      { type: 'complete_conversation', descriptionTemplate: 'Retell the folk tale to {{listenerName}} using narrative vocabulary', countTemplate: 1 },
      { type: 'use_vocabulary', descriptionTemplate: 'Use {{wordCount}} past tense verbs and emotional vocabulary', countTemplate: '{{wordCount}}' },
    ],
    completionCriteria: { type: 'conversation_engagement', requiredMessages: 8 },
    baseXp: 45,
    tags: ['storytelling', 'narrative', 'listening', 'retelling', 'past_tense', 'advanced'],
  },
  {
    id: 'my_adventure',
    name: 'My Adventure',
    ...
    difficulty: 'intermediate',
    params: [
      { name: 'npcName', type: 'string', description: 'NPC journalist/scribe' },
      { name: 'turns', type: 'number', description: 'Minimum conversation turns', defaultValue: 5 },
      { name: 'wordCount', type: 'number', description: 'Past tense and descriptive words', defaultValue: 8 },
    ],
    titleTemplate: 'My Adventure (told to {{npcName}})',
    descriptionTemplate: 'Describe your in-game experiences to {{npcName}} the scribe using past tense and descriptive vocabulary in {{targetLanguage}}.',
    questType: 'storytelling',
    objectiveTemplates: [
      { type: 'complete_conversation', descriptionTemplate: 'Tell {{npcName}} about your adventures in a {{turns}}-turn conversation', countTemplate: '{{turns}}' },
      { type: 'use_vocabulary', descriptionTemplate: 'Use {{wordCount}} past tense verbs and descriptive adjectives', countTemplate: '{{wordCount}}' },
    ],
    completionCriteria: { type: 'conversation_turns', requiredTurns: 5 },
    baseXp: 30,
    tags: ['storytelling', 'narrative', 'past_tense', 'descriptive', 'intermediate'],
  },
  {
    id: 'picture_this',
    name: 'Picture This',
    ...
    difficulty: 'intermediate',
    params: [
      { name: 'location', type: 'string', description: 'Location to visit and describe' },
      { name: 'npcName', type: 'string', description: 'NPC who cannot see the scene' },
      { name: 'turns', type: 'number', description: 'Minimum conversation turns', defaultValue: 4 },
      { name: 'wordCount', type: 'number', description: 'Descriptive and spatial words', defaultValue: 6 },
    ],
    titleTemplate: 'Picture This: {{location}}',
    descriptionTemplate: 'Visit {{location}} and describe the scene to {{npcName}}, who cannot see it, using vivid descriptive language in {{targetLanguage}}.',
    questType: 'storytelling',
    objectiveTemplates: [
      { type: 'visit_location', descriptionTemplate: 'Visit {{location}} to observe the scene', countTemplate: 1 },
      { type: 'complete_conversation', descriptionTemplate: 'Describe the scene at {{location}} to {{npcName}}', countTemplate: '{{turns}}' },
      { type: 'use_vocabulary', descriptionTemplate: 'Use {{wordCount}} descriptive adjectives and spatial vocabulary', countTemplate: '{{wordCount}}' },
    ],
    completionCriteria: { type: 'conversation_turns', requiredTurns: 4 },
    baseXp: 30,
    tags: ['storytelling', 'narrative', 'descriptive', 'spatial', 'intermediate'],
  },
